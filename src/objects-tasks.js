...
function shallowCopy(obj) {
  const objShallowCopy = {};
  return Object.assign(objShallowCopy, obj);
}
...
function mergeObjects(objects) {
  return objects.reduce((acc, curObj) => {
...
function makeWord(lettersObject) {
  const lettersArr = Array(Object.values(lettersObject).flat().length).fill(
    '0'
  );
